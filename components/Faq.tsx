...
function TitleItem({ children }: { children: React.ReactNode }) {
  return (
    <h2 className='flex items-center gap-1 text-2xl text-black'>
      <CircleHelp /> {children}
    </h2>
  );
}
...
export default function Faq() {
  ...
  return (
    <div className='mx-auto max-w-pc space-y-8 pb-5'>
      <h1 className='text-center text-2xl font-bold text-black lg:pb-3 lg:text-3xl'>{t('title')}</h1>
      <div className='grid grid-cols-1 gap-5 px-3 lg:gap-16 lg:px-0'>
        <div>
