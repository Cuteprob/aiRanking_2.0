  ...
  return (
    <div className='mb-10 hidden w-full lg:block'>
      <Table className='border-separate border-spacing-y-3'>
        <TableHeader>
          <TableRow className='tr-rounded h-16 rounded-[4px] border-none bg-[#6219F0] hover:bg-[#6219F0]'>
        ...
        <TableBody className='space-y-3'>
          {STARTUP_LIST.map((item) => (
            <TableRow
              key={item.DA}
              className='tr-rounded h-16 rounded-[4px] border-none bg-white/30 hover:bg-[#6219F0]/20'
            >
